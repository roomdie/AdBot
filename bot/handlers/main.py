...
from .message_handler.channel_handler import channel_handler, channel_id_handler

dp.register_message_handler(start, commands='start')
dp.register_message_handler(check_referral, regexp="🔸 Referral's")
...
dp.register_callback_query_handler(channel_id_handler, state=ChannelId.channel_id)
